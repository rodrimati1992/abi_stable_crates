...
#[export_root_module]
extern fn instantiate_root_module()->&'static ShopMod{
    extern_fn_panic_handling!{
        ShopModVal {
            new,
            deserialize_command,
...
pub extern "C" fn new()->Shop_TO<'static,RBox<()>>{
    extern_fn_panic_handling!{
...
extern "C" fn deserialize_command(s:RStr<'_>)->RResult<NonExhaustiveFor<Command>,RBoxError>{
    extern_fn_panic_handling!{
...
extern "C" fn deserialize_ret_val(s:RStr<'_>)->RResult<NonExhaustiveFor<ReturnVal>,RBoxError>{
    extern_fn_panic_handling!{
