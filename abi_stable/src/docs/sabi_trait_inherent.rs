...
impl<'lt, ErasedPtr, …> Trait_TO<'lt, ErasedPtr, …> {
    pub fn from_ptr<Ptr, Unerasability>(
        pointer: Ptr,
...
The `unerasability` parameter describes whether the trait object can be 
...
// From an RBox
{
    ...
    let mut object: Action_TO<'static, RBox<()>> =
        Action_TO::from_ptr(RBox::new(10_usize), TU_Unerasable);
...
// From a reference
{
    ...
    let object: Action_TO<'static, RRef<'static, ()>> =
        Action_TO::from_ptr(&20_usize, TU_Unerasable);
...
// From a mutable reference
{
    ...
    let mut object: Action_TO<'static, RMut<'_, ()>> =
        Action_TO::from_ptr(&mut val, TU_Unerasable);
...
// From an RArc
{
    let object: Action_TO<'static, RArc<()>> =
        Action_TO::from_ptr(RArc::new(40), TU_Unerasable);
...
impl<'lt, …> Trait_TO<'lt, RBox<()>, …> {
    pub fn from_value<_OrigPtr, Unerasability>(
        pointer: _OrigPtr,
        unerasability: Unerasability
    ) -> Self 
```
...
// The type annotation is purely for the reader.
let mut object: Action_TO<'static, RBox<()>> =
    Action_TO::from_value(100_usize, TU_Unerasable);
...
let mut object: Action_TO<'static, RBox<()>> = 
    Action_TO::from_value(700, TU_Unerasable);
...
let mut object: Action_TO<'static, RBox<()>> =
    Action_TO::from_value(300_usize, TU_Unerasable);
...
let mut object: Action_TO<'static, RBox<()>> =
    Action_TO::from_value(400_usize, TU_Unerasable);
...
[`TU_Unerasable`]: ../../type_level/unerasability/struct.TU_Unerasable.html

[`TU_Opaque`]: ../../type_level/unerasability/struct.TU_Opaque.html
