...
- `Trait_MV`:
    A helper type used to construct the vtable to 
    construct the trait object in constants.

- `Trait_CTO`:A type alias for the trait object constructible in constants.
