...
mod display{
    ...
    const STRUCT_1_LAYS: RSlice<'static,AlwaysDisplay<Constructor<&'static TypeLayout>>>=
        rslice![
            AlwaysDisplay(Constructor(get_type_layout::<Struct1>)),
        ];

    const STRUCT_2_LAYS: RSlice<'static,AlwaysDisplay<Constructor<&'static TypeLayout>>>=
        rslice![
...
mod debug{
    ...
    const STRUCT_0_LAYS: RSlice<'static,Constructor<&'static TypeLayout>>=
        rslice![];

    const STRUCT_1_LAYS: RSlice<'static,Constructor<&'static TypeLayout>>=
        rslice![
            Constructor(get_type_layout::<Struct1>),
        ];

    const STRUCT_2_LAYS: RSlice<'static,Constructor<&'static TypeLayout>>=
        rslice![
