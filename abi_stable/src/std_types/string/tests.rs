...
fn drain() {
    ...
    must_panic(file_span!(),|| rstr.drain(broken_heart_pos..broken_heart_pos+1) ).unwrap();
    must_panic(file_span!(),|| rstr.drain(broken_heart_pos+1..broken_heart_pos+2) ).unwrap();
    must_panic(file_span!(),|| rstr.drain(broken_heart_pos+1..broken_heart_pos+3) ).unwrap();
    must_panic(file_span!(),|| rstr.drain(broken_heart_pos+1..) ).unwrap();
